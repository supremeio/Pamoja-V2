    ...
    <div className={className}>
      ...
      <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
        <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
          <Link href="/v2/dashboard" className="w-full cursor-pointer block group" prefetch={true}>
          ...
          <Link href="/v2/applications" className="w-full cursor-pointer block group" prefetch={true}>
            <div className={`box-border content-stretch flex flex-col items-start justify-center px-[12px] py-[8px] relative rounded-[8px] shrink-0 w-full transition-all duration-200 ease-out ${
              isApplications 
                ? 'bg-v2-background-secondary' 
                : 'bg-v2-background-primary hover:bg-v2-background-secondary active:scale-[0.98]'
          ...
          <Link href="/v2/toolkit" className="w-full cursor-pointer block group" prefetch={true}>
            <div className={`box-border content-stretch flex flex-col items-start justify-center px-[12px] py-[8px] relative rounded-[8px] shrink-0 w-full transition-all duration-200 ease-out ${
              isToolkit 
                ? 'bg-v2-background-secondary' 
                : 'bg-v2-background-primary hover:bg-v2-background-secondary active:scale-[0.98]'
        ...
        <Separator />
        <a href="mailto:oluwatosinsamk@gmail.com" className="w-full cursor-pointer block group">
