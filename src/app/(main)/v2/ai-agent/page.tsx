    ...
    if (isAgentActive && !isAgentPaused) {
      setProcesses(prev => {
        ...
        if (!hasLoading && !hasCompleted) {
          return prev.map((p, index): ProcessItem => ({
            ...p,
            status: (index === 0 ? 'loading' : 'pending') as ProcessItem['status']
          }))
        }
                ...
                <div className="basis-0 content-stretch flex flex-col gap-[4px] grow items-start min-h-px min-w-px relative shrink-0">
                  <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full">
                    ...
                    <div 
                      ...
                      style={{
                        backgroundColor: isAgentActive ? colorValues.status.accepted.bg : colorValues.status.offer.bg,
                        borderColor: isAgentActive ? colorValues.status.accepted.border : colorValues.status.offer.border
                      }}
                    >
                      <p 
                        ...
                        style={{
                          ...fontMedium,
                          color: isAgentActive ? colorValues.status.accepted.text : colorValues.status.offer.text
                        }}
                      >
                  ...
                  <p className="leading-[1.7] not-italic relative shrink-0 text-[14px] text-v2-text-secondary w-full" style={fontMedium}>
                    Automatically apply to listings 24/7. The agent analyzes job boards, optimizes your resume using your knowledge base, and submits tailored applications to maximize your interview rate.
                  </p>
                </div>
                ...
                <div className="content-stretch flex gap-[24px] items-start relative shrink-0">
                  ...
                  <div className="bg-v2-background-secondary box-border content-stretch flex gap-[20px] items-center p-[16px] relative rounded-[8px] shrink-0">
                    <div className="content-stretch flex flex-col items-start relative shrink-0">
                      <p className="leading-[1.7] not-italic relative shrink-0 text-[14px] text-nowrap text-v2-text-primary whitespace-pre" style={fontMedium}>
                        {isAgentActive ? 'Credits remaining' : 'Credits available'}
                      </p>
                      <div className="content-stretch flex items-center not-italic relative shrink-0 text-[14px] text-nowrap whitespace-pre" style={fontMedium}>
                        <p className="leading-[20px] relative shrink-0 tracking-[-0.14px]" style={{ color: colorValues.success.primary }}>
                          {isAgentActive ? '125' : '500'}
                        </p>
                        <p className="leading-[1.7] relative shrink-0 text-v2-text-secondary">
                          /
                        </p>
                    ...
                    <button 
                      ...
                      style={{
                        backgroundColor: isAgentPaused 
                          ...
                          : (isHoveringAgentButton ? colorValues.background.secondary : colorValues.status.accepted.bg),
                        border: isAgentPaused ? 'none' : (isHoveringAgentButton ? `1px solid ${colorValues.border.default}` : 'none'),
                      ...
                      <p 
                        ...
                        style={{
                          ...
                          color: isAgentPaused 
                            ...
                            : (isHoveringAgentButton ? colorValues.text.primary : colorValues.success.primary)
                        }}
                      >
                        {isAgentPaused ? 'Resume agent' : (isHoveringAgentButton ? 'Pause agent' : 'Agent running')}
                      </p>
                    </button>
                  ) : (
                    /* Get started button */
            ...
            {isAgentActive ? (
              <>
                ...
                <div className="bg-[#112531] box-border content-stretch flex flex-col gap-[4px] items-start p-[24px] relative rounded-[8px] shrink-0 w-full">
                  <p className="leading-[28px] not-italic relative shrink-0 text-[18px] text-nowrap text-v2-text-primary whitespace-pre" style={fontSemibold}>
                    Your AI agent is now active!
                  </p>
                  <p className="leading-[1.7] min-w-full not-italic relative shrink-0 text-[14px] text-v2-text-secondary w-full" style={fontMedium}>
                    Your agent is scanning job boards right now. You'll start seeing results within the next few minutes. We'll notify you when applications are generated and sent.
                  </p>
                ...
                >
                  {(() => {
                    ...
                    const totalOffset = (cycleOffset * processes.length + completedCount) * itemSpacing
                    ...
                    if (startIndex + 3 > processes.length && cycleOffset > 0) {
                      ...
                      visibleProcesses.push({ ...nextCycleFirst, id: `${nextCycleFirst.id}-next-cycle` })
                    }
