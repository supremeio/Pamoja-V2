...
export default function ResultPage() {
  ...
  const handleEditResume = useCallback((e: React.MouseEvent) => {
    e.stopPropagation()
    setResumeEditValue(resumeContent)
    setIsEditingResume(true)
  }, [resumeContent])

  const handleSaveResume = useCallback((e: React.MouseEvent) => {
    e.stopPropagation()
  ...
  const handleCopyResume = useCallback((e: React.MouseEvent) => {
    e.stopPropagation()
  ...
  const handleEditCoverLetter = useCallback((e: React.MouseEvent) => {
    e.stopPropagation()
    setCoverLetterEditValue(coverLetterContent)
    setIsEditingCoverLetter(true)
  }, [coverLetterContent])

  const handleSaveCoverLetter = useCallback((e: React.MouseEvent) => {
    e.stopPropagation()
  ...
  const handleCopyCoverLetter = useCallback((e: React.MouseEvent) => {
    e.stopPropagation()
  ...
  const handleCoverLetterTextareaChange = useCallback((e: React.ChangeEvent<HTMLTextAreaElement>) => {
    const newValue = e.target.value
  ...
  useEffect(() => {
    if (isEditingResume && resumeTextareaRef.current) {
      resumeTextareaRef.current.focus()
      resumeTextareaRef.current.setSelectionRange(resumeTextareaRef.current.value.length, resumeTextareaRef.current.value.length)
    }
  }, [isEditingResume])
  ...
  useEffect(() => {
    if (isEditingCoverLetter && coverLetterTextareaRef.current) {
      coverLetterTextareaRef.current.focus()
      coverLetterTextareaRef.current.setSelectionRange(coverLetterTextareaRef.current.value.length, coverLetterTextareaRef.current.value.length)
    }
  ...
  const resumeTextareaContainerStyle = useMemo(() => ({
    ...
    borderColor: isResumeTextareaFocused || (isResumeTextareaTyping && hasResumeEditText) ? '#ffffff' : '#252628',
    borderWidth: '1px',
    borderStyle: 'solid',
  ...
  const coverLetterTextareaContainerStyle = useMemo(() => ({
    backgroundColor: '#151619',
    borderColor: isCoverLetterTextareaFocused || (isCoverLetterTextareaTyping && hasCoverLetterEditText) ? '#ffffff' : '#252628',
    borderWidth: '1px',
    borderStyle: 'solid',
    transition: 'border-color 200ms cubic-bezier(0.4, 0, 0.2, 1), background-color 200ms cubic-bezier(0.4, 0, 0.2, 1)'
  ...
  }, [hasCoverLetterEditText, isCoverLetterTextareaFocused, isCoverLetterTextareaHovered, isCoverLetterTextareaTyping])
        ...
        <div className="flex-1 flex flex-col overflow-hidden min-h-0">
          ...
          <div className="flex-shrink-0 px-[24px] pt-[24px] pb-[24px]">
            <div className="content-stretch flex font-['Figtree:Medium',sans-serif] gap-[4px] items-center leading-[20px] not-italic relative shrink-0 text-[14px] text-nowrap tracking-[-0.14px] w-full whitespace-pre">
              <Link href="/v2/dashboard" className="[text-underline-position:from-font] decoration-solid relative shrink-0 text-v2-text-primary underline">
                Dashboard
              </Link>
              <p className="relative shrink-0 text-v2-text-primary">
                /
              </p>
              <p className="relative shrink-0 text-v2-text-muted">
            ...
            <div className="content-stretch flex items-start justify-between relative shrink-0 w-full">
              <div className="basis-0 content-stretch flex flex-col gap-[32px] grow items-start justify-center min-h-px min-w-px relative shrink-0">
                <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 w-full">
                  <p className="font-['Figtree:SemiBold',sans-serif] leading-[28px] relative shrink-0 text-[18px] text-v2-text-primary w-full" style={fontSemibold}>
                    Application analysis
                  </p>
                  <p className="font-['Figtree:Medium',sans-serif] leading-[1.7] relative shrink-0 text-[14px] text-v2-text-secondary w-full" style={fontMedium}>
              ...
              <button
                ...
                style={{
                  ...
                  transition: 'background-color 300ms cubic-bezier(0.16, 1, 0.3, 1), transform 200ms cubic-bezier(0.4, 0, 0.2, 1)',
                ...
                <div className="overflow-clip relative shrink-0 size-[20px]">
                  {saveJobState === 'default' && (
                    <div className="absolute contents inset-0">
                      <img alt="" className="block max-w-none size-full" src={imgSaveIcon} style={{ width: '16px', height: '16px' }} />
                    </div>
                  )}
                  {saveJobState === 'saving' && (
                    <div className="absolute contents inset-0">
            ...
            <div className="content-stretch flex gap-[40px] items-start relative shrink-0 w-full">
              ...
              <div className="basis-0 content-stretch flex flex-col gap-[24px] grow items-start min-h-px min-w-px relative shrink-0">
                ...
                <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 w-full">
                  ...
                  <p className="font-['Figtree:Medium',sans-serif] leading-[24px] min-w-full relative shrink-0 text-[15px] text-v2-text-secondary tracking-[-0.15px] w-[min-content]" style={fontMedium}>
                ...
                <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
                  <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full">
                    ...
                    <div className="basis-0 bg-[#1a1b1e] box-border content-stretch flex flex-col gap-[8px] grow h-[400px] items-start min-h-px min-w-px p-[16px] relative rounded-[8px] shrink-0" style={{ isolation: 'isolate' }}>
                      <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" style={{ cursor: 'default', isolation: 'isolate', zIndex: 1 }}>
                        <div className="content-stretch flex gap-[12px] items-start relative shrink-0">
                          <p className="font-['Figtree:SemiBold',sans-serif] leading-[28px] not-italic relative shrink-0 text-[18px] text-v2-text-primary text-nowrap whitespace-pre" style={fontSemibold}>
                            Optimized resume
                          </p>
                          <div className="bg-[#123520] border border-[#386f4e] border-solid box-border content-stretch flex items-center justify-center px-[12px] py-[2px] relative rounded-[40px] shrink-0">
                            <p className="font-['Figtree:Medium',sans-serif] leading-[1.7] not-italic relative shrink-0 text-[#48ba77] text-[14px] text-nowrap whitespace-pre" style={fontMedium}>
                              ATS: 88%
                            </p>
                          </div>
                        </div>
                        <div className="content-stretch flex gap-[8px] items-center relative shrink-0 icon-button" style={{ cursor: 'default', zIndex: 30, position: 'relative', pointerEvents: 'auto', isolation: 'isolate' }}>
                          {isEditingResume ? (
                            <div
                            ...
                            <>
                              ...
                              >
                                <div className="absolute contents inset-0" style={{ pointerEvents: 'none', cursor: 'pointer' }}>
                                  <img 
                                    alt="" 
                                    draggable="false"
                                    className="block max-w-none size-full" 
                      ...
                      {isEditingResume ? (
                        ...
                        <div className="v2-scrollbar content-stretch flex flex-col gap-[4px] items-end justify-center relative shrink-0 w-full overflow-y-auto max-h-[320px]" style={{ cursor: 'default', pointerEvents: 'auto', isolation: 'isolate' }}>
                          <div 
                          ...
                          >
                            {resumeContent.split('\n').map((line: string, index: number) => (
                              <p key={index} className="mb-0" style={{ cursor: 'text', pointerEvents: 'auto' }}>{line || '\u00A0'}</p>
                            ))}
                          </div>
                        </div>
                      )}
                    ...
                    <div className="basis-0 bg-[#1a1b1e] box-border content-stretch flex flex-col gap-[8px] grow h-[400px] items-start min-h-px min-w-px p-[16px] relative rounded-[8px] shrink-0" style={{ isolation: 'isolate' }}>
                      <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" style={{ isolation: 'isolate', zIndex: 1 }}>
                        <p className="font-['Figtree:SemiBold',sans-serif] leading-[28px] not-italic relative shrink-0 text-[18px] text-v2-text-primary text-nowrap whitespace-pre" style={fontSemibold}>
                          Generated cover letter
                        </p>
                        <div className="content-stretch flex gap-[8px] items-center relative shrink-0 icon-button" style={{ cursor: 'default', zIndex: 10, position: 'relative' }}>
                          {isEditingCoverLetter ? (
                            <div
                      ...
                      {isEditingCoverLetter ? (
                        ...
                        <div className="v2-scrollbar content-stretch flex flex-col gap-[4px] items-end justify-center relative shrink-0 w-full overflow-y-auto max-h-[320px]" style={{ cursor: 'default' }}>
                          <div 
                            className="font-['Figtree:Medium',sans-serif] leading-[20px] min-w-full not-italic relative shrink-0 text-[14px] text-v2-text-secondary w-[min-content] whitespace-pre-wrap" 
                            style={{
                              ...fontMedium,
                          ...
                          >
                            {coverLetterContent.split('\n').map((line: string, index: number) => (
                              <p key={index} className="mb-0" style={{ cursor: 'text' }}>{line || '\u00A0'}</p>
                            ))}
                          </div>
                        </div>
                      )}
                      ...
                      <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
                        ...
                        >
                          <div className="relative shrink-0 size-[24px] pointer-events-none">
                            <img alt="" className="block max-w-none size-full" src={imgDropdownIcon} />
                          </div>
                        </button>
                      </div>
                      <div
                        ...
                        style={{
                          ...
                          transition: 'max-height 500ms cubic-bezier(0.16, 1, 0.3, 1), opacity 500ms cubic-bezier(0.16, 1, 0.3, 1)',
                      ...
                      >
                        <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full pt-[0px]">
                          ...
                          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
                            <p className="font-['Figtree:Medium',sans-serif] leading-[1.7] not-italic relative shrink-0 text-[#7296ac] text-[14px] uppercase w-full" style={fontMedium}>
                              Keywords added
                            </p>
                            <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full flex-wrap">
                              <div className="bg-v2-background-secondary border border-v2-border border-solid box-border content-stretch flex gap-[10px] items-center justify-center px-[12px] py-[4px] relative rounded-[40px] shrink-0">
                                <p className="font-['Figtree:Medium',sans-serif] leading-[1.7] not-italic relative shrink-0 text-[14px] text-v2-text-primary text-nowrap whitespace-pre" style={fontMedium}>
                                  Interface design
                                </p>
                              </div>
                              <div className="bg-v2-background-secondary border border-v2-border border-solid box-border content-stretch flex gap-[10px] items-center justify-center px-[12px] py-[4px] relative rounded-[40px] shrink-0">
                          ...
                          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
                            ...
                            <div className="relative shrink-0 w-full">
                              {[
                                {
                                  original: 'Redesigned the expense management function, integrating AI-driven OCR',
                                  improved: 'Redesigned the funding management function, implementing AI-driven OCR'
                                }
                                ...
                                <div key={index} className="relative w-full">
                                  ...
                                  <div className="border-[#d37e76] border-l-[1px] border-solid box-border bg-[#311614] h-[40px] relative">
                                    <p className="font-['Figtree:Medium',sans-serif] leading-[20px] not-italic text-[14px] text-v2-text-secondary absolute inset-0 flex items-center px-[10px]" style={fontMedium}>
                    ...
                    <div className="basis-0 content-stretch flex flex-col gap-[16px] grow items-start min-h-px min-w-px relative shrink-0">
                      <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
                        ...
                        <button
                          ...
                          className="flex items-center justify-center relative shrink-0 cursor-pointer transition-transform duration-200 ease-in-out hover:opacity-80"
                          style={{ 
                            transform: isOriginalResumeExpanded ? 'rotate(0deg)' : 'rotate(180deg)', 
                            transition: 'transform 200ms cubic-bezier(0.4, 0, 0.2, 1)',
                            pointerEvents: 'auto',
                            zIndex: 10
                          }}
                      ...
                      >
                        <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full pt-[0px]">
                          <div className="v2-scrollbar content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full overflow-y-auto max-h-[400px]">
                            <div className="font-['Figtree:Medium',sans-serif] leading-[20px] min-w-full not-italic relative shrink-0 text-[14px] text-v2-text-secondary w-full whitespace-pre-wrap" style={fontMedium}>
                              <p className="mb-0">Oluwatosin Kazeem</p>
                              <p className="mb-0">Lagos, Nigeria | supremeux@gmail.com | LinkedIn URL | Portfolio</p>
                              <p className="mb-0">&nbsp;</p>
                              ...
                              <p className="mb-0">Owned the design and development of a comprehensive design system, enhancing product release cycles by 25% and ensuring a consistent, visually polished user experience across the FinTech platform.</p>
                              <p className="mb-0">Redesigned the expense management function, integrating AI-driven OCR automation to reduce manual data entry by 20% and improve user satisfaction.</p>
                            </div>
                          </div>
                        </div>
                      </div>
