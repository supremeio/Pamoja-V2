...
const ApplyJobModal = lazy(() =>
  import('@/components/v2/ApplyJobModal').then(m => ({ default: m.ApplyJobModal }))
)
const OptimizeResumeModal = lazy(() =>
  import('@/components/v2/OptimizeResumeModal').then(m => ({ default: m.OptimizeResumeModal }))
)
const GenerateCoverLetterModal = lazy(() =>
  import('@/components/v2/GenerateCoverLetterModal').then(m => ({
    default: m.GenerateCoverLetterModal,
  }))
)
const AddApplicationModal = lazy(() =>
  import('@/components/v2/AddApplicationModal').then(m => ({ default: m.AddApplicationModal }))
)
const DeleteApplicationModal = lazy(() =>
  import('@/components/v2/DeleteApplicationModal').then(m => ({
    default: m.DeleteApplicationModal,
  }))
)
...
function Dashboard() {
  ...
  const handleGenerateCoverLetterSubmit = useCallback(
    async (_data: {
      company: string
      role: string
      jobDescription: string
            ...
            <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-full">
              ...
              <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
                ...
                <div className="basis-0 bg-v2-background-secondary box-border content-stretch flex flex-col gap-[20px] grow items-start min-h-px min-w-px p-[16px] relative rounded-[8px] shrink-0">
                  <p
                    className="leading-[normal] not-italic relative shrink-0 text-[14px] text-v2-text-primary tracking-[-0.14px] w-full"
                    style={fontMedium}
                  >
                    Total applications
                  </p>
                ...
                <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
                  ...
                  <div className="content-stretch flex gap-[3px] items-center relative shrink-0 w-full">
                    <div className="basis-0 box-border content-stretch flex gap-[10px] grow items-center min-h-px min-w-px p-[16px] relative shrink-0">
                      <p
                        className="leading-[1.7] not-italic relative shrink-0 text-[14px] text-v2-text-secondary text-nowrap uppercase whitespace-pre"
                        style={fontRegular}
                      >
                        Company's name
                      </p>
